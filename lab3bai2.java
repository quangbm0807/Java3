...
public class bai2 {
    ...
    static JRadioButton rdoCoding = new JRadioButton("Coding");
    static JRadioButton rdoCodingToTie = new JRadioButton("Coding to tie");
    static JRadioButton rdoCodingToDead = new JRadioButton("Coding to dead");
